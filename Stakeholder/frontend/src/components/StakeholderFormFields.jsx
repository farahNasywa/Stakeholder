...
// Tanda bintang merah untuk field wajib. Diletakkan dalam <span> yang sama
// dengan teks label (bukan sebagai child langsung labelStyle) supaya tidak
// ikut kena `gap` flex antara ikon dan teks, dan tetap sejajar/rapat dengan
// teks label baik di desktop maupun mobile.
const RequiredMark = () => (
 ...
 *
 * Indikator wajib: Stakeholder Name, Stakeholder Type, Engagement Category,
 * Province, dan City menampilkan tanda bintang merah (*) pada label serta
 * atribut `required`. Role, District, dan Contact bersifat opsional (tanpa
 * bintang, tanpa `required`).
 */
