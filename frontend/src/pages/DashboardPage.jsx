...
const DashboardPage = () => {
  ...
  useEffect(() => {
    // Diagram "By Status" harus mencerminkan APA ADANYA jumlah status di
    // database (field stakeholder.status), tanpa logika tambahan/override
    // apa pun. Kalau di database ada 5 Approved, diagram harus tampil 5.
    api.get(API_URL)
      .then((res) => {
